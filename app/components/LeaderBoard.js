    ...
    return (
      <View key={key} style={styles.leaderboard_score}>
        <View style={styles.leaderboard_score_flex}>
          ...
          <Text style={styles.leaderboard_score_text_2}>
            Tricolor: {HelperUtils.formatTriColor(score.triColor)}
          </Text>
    ...
    return (
      <View style={styles.leaderboard}>
        ...
        <View style={{ flex: 7, marginBottom: 30 }}>
          <ScrollView>
            {this.props.leaderboard.map((score, key) =>
              Leaderboard.getLeaderboardRow(score, key),
            )}
          </ScrollView>
        </View>
      </View>
